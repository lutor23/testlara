        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Create New Rule for widgetid: {{$id}}</div>
                    <div class="panel-body">
                        ...
                        {!! Form::open(['url' => '/rules/min', 'class' => 'form-horizontal', 'files' => true]) !!}

<!--             <div class="form-group {{ $errors->has('widget_id') ? 'has-error' : ''}}">
                {!! Form::label('widget_id1', 'Widget Id', ['class' => 'col-md-4 control-label']) !!}
               
                <div class="col-md-6">
                    {!! Form::label('widget_id2',  $id , ['class' => 'form-control']) !!}

                </div>
           </div>
 -->
            <input type='hidden' id='widget_id' name='widget_id' value={{$id}} >
